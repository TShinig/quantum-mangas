...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create quantum-mangas-b13a
  fly apps create quantum-mangas-b13a-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app quantum-mangas-b13a
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app quantum-mangas-b13a-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'quantum-mangas-b13a-staging' does not match app name in config file 'quantum-mangas-b13a'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name quantum-mangas-b13a-db
  fly postgres attach --app quantum-mangas-b13a quantum-mangas-b13a-db

  fly postgres create --name quantum-mangas-b13a-staging-db
  fly postgres attach --app quantum-mangas-b13a-staging quantum-mangas-b13a-staging-db
  ```
